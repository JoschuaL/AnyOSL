...
public:
    virtual void operator()(int errcode, const std::string& msg)
    {
        ...
        case EH_WARNING:
            ...
            break;
        case EH_ERROR: std::cerr << msg << std::endl; break;
        case EH_SEVERE: std::cerr << msg << std::endl; break;
        case EH_DEBUG:
#ifdef NDEBUG
            break;
#endif
...
main(int argc, const char* argv[])
{
    ...
    for (int a = 1; a < argc; ++a) {
        ...
        } else if (!strcmp(argv[a], "-E") || !strcmp(argv[a], "-M")
                   || !strcmp(argv[a], "--dependencies")
                   || !strcmp(argv[a], "-MM")
                   || !strcmp(argv[a], "--user-dependencies")) {
            args.emplace_back(argv[a]);
            quiet = true;
        } else if (!strcmp(argv[a], "-v") || !strcmp(argv[a], "-d")
                   ...
                   || !strcmp(argv[a], "--embed-source")
                   || !strcmp(argv[a], "-MD")
                   || !strcmp(argv[a], "--write-dependencies")
                   || !strcmp(argv[a], "-MMD")
                   || !strcmp(argv[a], "--write-user-dependencies")
